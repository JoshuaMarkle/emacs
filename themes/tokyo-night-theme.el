;; tokyo-night-theme.el --- The best dark theme -*- lexical-binding: t; no-byte-compile: t; -*-
...
(defgroup tokyo-night-theme nil
    "Options for doom-themes"
    :group 'doom-themes)

(defcustom tokyo-night-brighter-modeline nil
    "If non-nil, more vivid colors will be used to style the mode-line."
    :group 'tokyo-night-theme
    :type 'boolean)

(defcustom tokyo-night-brighter-comments nil
    "If non-nil, comments will be highlighted in more vivid colors."
    :group 'tokyo-night-theme
    :type 'boolean)

(defcustom tokyo-night-comment-bg tokyo-night-brighter-comments
    "If non-nil, comments will have a subtle, darker background. Enhancing their legibility."
    :group 'tokyo-night-theme
    :type 'boolean)

(defcustom tokyo-night-padded-modeline nil
...
(def-doom-theme tokyo-night
    ...
    ((bg         '("#1a1b26" nil       nil            ))
        ...
        (selection      base0)
        (builtin        red)
        (comments       (if tokyo-night-brighter-comments base5 base1))
        (doc-comments   (doom-lighten (if tokyo-night-brighter-comments base5 base1) 0.25))
        (constants      orange)
        (functions      blue)
        (keywords       magenta)
        (methods        blue)
    ...
    ;; custom categories
        ...
        (-modeline-bright tokyo-night-brighter-modeline)
        (-modeline-pad
            (when tokyo-night-padded-modeline
                (if (integerp tokyo-night-padded-modeline) tokyo-night-padded-modeline 4)))
    ...
    (
        ...
        ((line-number &override) :foreground comments :background (doom-darken bg 0.05))

        (font-lock-comment-face
            :foreground comments
            :background (if tokyo-night-comment-bg (doom-lighten bg 0.05) 'unspecified))
        (font-lock-doc-face

...
(defun my/display-buffer-at-right (buffer alist)
  "Display BUFFER at the right side, taking up a third of the screen width or a maximum of 70 characters."
  (let ((window-width (max (min (floor (* 0.33 (frame-width))) 70) 40)))  ; Adjust 0.33 to increase/decrease
...
(after! compile
  (setq display-buffer-alist
        '(("\\*compilation\\*" . (my/display-buffer-at-right . ((reusable-frames . t)))))))
